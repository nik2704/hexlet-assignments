    ...
    void testUpdatePerson() throws Exception {
        MockHttpServletResponse responsePatch = mockMvc
                .perform(
                        patch("/people/1")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\"firstName\": \"Ivan\", \"lastName\": \"Yvanov\"}")
                )
                .andReturn()
                .getResponse();
        ...
        assertThat(responseGetAll.getContentAsString()).contains("Ivan", "Yvanov");
        assertThat(responseGetAll.getContentAsString()).doesNotContain("John", "Smith");
    }

    @Test
    void testDeletePerson() throws Exception {
        MockHttpServletResponse responseDeletePerson = mockMvc
                .perform(delete("/people/1"))
                .andReturn()
                .getResponse();

        assertThat(responseDeletePerson.getStatus()).isEqualTo(200);
